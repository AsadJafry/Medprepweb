...
const Navbar2 = () => {
  ...
  return (
    ...
    <nav className="hidden md:flex space-x-8 text-lg">
      <Link to="/" className="hover:text-gray-700">About</Link>
      <a href="#" className="hover:text-gray-700">Learn</a>
      <Link to="/home" className="hover:text-gray-700">Home</Link>
      <Link to="/contactus" className="hover:text-gray-700">Contact Us</Link>
    </nav>
  
    {/* <a href="#" className="bg-black text-white px-4 py-2 pr-8 rounded hover:bg-gray-800">
      Sign In
    </a> */}
    <Link to={'/signup'} className="bg-black text-white px-4 py-2 pr-8 rounded hover:bg-gray-800">
      Sign In
    </Link>
  </header>
  );
